...
- **UFDM is sensitive to AdamW weight decay (WD).** Estimator effectiveness depend strongly on WD.
...
- **For d > 50 with n = 750**, UFDM’s power degrades markedly, indicating a strong sample-size–to-dimension limitation.
